...
/* Come up with an object that uses all valid (serializable)
  ...
  const object = {a: [1], b: new Date("04-04-2024"), c: (a) => a + 1, d: {a1: 2}, e: new Error("error!"), f: false, g: null, h: 2, i: "string", j: undefined};
...
/* Come up with a string that is not a valid serialized object. */
  ...
  const malformedSerializedString = {a: Symbol("@")};
